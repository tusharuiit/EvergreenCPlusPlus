...
void printinorder_1 ( node * ) ;
void printinorder_2 ( node * ) ;
...
void printinorder_1 ( node * root )
{
   if( root->leftnode != NULL )
   {
       printinorder_1(root->leftnode);
   }
   std::cout<<root->value<<std::endl;
   if ( root->rightnode != NULL )
   {
      printinorder_1(root->rightnode);
   }
}

void printinorder_2 ( node * root )
{
   if(root == NULL)
   { return ; }
   printinorder_2( root->leftnode );
   std::cout<<root->value<<std::endl;
   printinorder_2( root->rightnode );
}
