...
void copy ( int * arr , int ** newarr , const int beg , const int end ) ;
...
// creating a random array
   ...
   copy ( arr , &newarr , 0 , num - 1  ) ;
   std::cout<<" And the UNSORTED newarr numbers are " << std::endl ;
   print_list ( newarr ,  0 , num - 1 ) ;
   std::cout<<" And the UNSORTED arr numbers are " << std::endl ;
...
void mergesort_list( int * arr , int * newarr , const int beg , const int end )
{
   ...
   if( (end-beg) >= 1 )
   {
      std::cout << "In (end-beg) >= 1 "<< std::endl ;
